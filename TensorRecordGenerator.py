...
def storeTrainData(train_addrs, train_labels):
    train_filename = 'train.tfrecordsTEST'  # address to save the TFRecords file
...
def generateTrainData():
    ...
    spectrograms_train_path = '../trainSet1/constQSpectrograms/*.png'
    # read addresses and labels from the 'train' folder
    addrs = glob.glob(spectrograms_train_path)
    labels = []
    for addr in addrs:
